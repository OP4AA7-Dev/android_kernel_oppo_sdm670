...
struct synaptics_rmi4_data {
    ...
    int (*reset_device)(struct synaptics_rmi4_data* rmi4_data, bool rebuild);
    int (*irq_enable)(struct synaptics_rmi4_data* rmi4_data, bool enable, bool attn_only);
    void (*sleep_enable)(struct synaptics_rmi4_data* rmi4_data, bool enable);
...
struct synaptics_dsx_bus_access {
    unsigned char type;
    int (*read)(struct synaptics_rmi4_data* rmi4_data, unsigned short addr, unsigned char* data,
                unsigned int length);
    int (*write)(struct synaptics_rmi4_data* rmi4_data, unsigned short addr, unsigned char* data,
                 unsigned int length);
};
...
struct chip_data_s3706 {
    ...
    struct synaptics_proc_operations*
            syna_ops; /*synaptics func provide to synaptics common driver*/
#ifdef CONFIG_SYNAPTIC_RED
